...
# Ensure we import from segment-gui/app, not gui/app
project_dir = Path(__file__).parent  # This gets the segment-gui directory
...
class SegmentLabelingWindow:
    ...
    def show_start_page(self):
        ...
        self.page = SegmentStartPage(
            self.container, on_continue=self.show_labeling_page
        )
