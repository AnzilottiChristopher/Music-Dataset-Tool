...
class AnalyzeButton(tk.Frame):
    ...
    def _create_segment_transitions(
        self, song_a, song_b, segments_a, segments_b, output_folder
    ):
        ...
        for exit_segment_type, exit_times in segments_a.items():
            ...
            last_exit_name, last_exit_times = self._get_segment_instance(
            ...
            for entry_base_type in compatible_entry_types:
                ...
                first_entry_name, first_entry_times = self._get_segment_instance(
                ...
                transition_style = self._get_transition_style(
                    exit_base_type, entry_base_type
                )
    ...
    def _get_transition_style(self, exit_type, entry_type):
        ...
        if exit_type in ["beat-drop", "chorus"] and entry_type in [
            "verse",
            "cool-down",
        ]:
            return {
